Twitclone::Application.routes.draw do
  ...
  match 'user_timeline/:username' => 'twits#user_timeline', :as => :user_timeline
  
  match 'follow/:username' => 'twits#follow', :as => :follow
  
  match 'unfollow/:username' =>  'twits#unfollow', :as => :unfollow
